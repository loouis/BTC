...
var mainMenuProductNav = $('.navigation__product-nav'),
	...
	$('.navigation__products-link').on('click', function(){
		scrollPos = win.scrollTop();
		mainHeader.toggleClass("navigation__products-link--active");
		contentContainer.toggleClass("p-nav-showing");
		$('body').addClass("no-touch");
	});

	win.scroll(function(){
		if( scrollPos > scrollPos+10 || scrollPos > scrollPos-10 ){
			contentContainer.removeClass("p-nav-showing");
			mainHeader.removeClass("navigation__products-link--active");
		}
	});
